...
### Planning & Strategy
- [Roadmap](ROADMAP.md) - Current and future direction of Project Connect
- [Social Media Strategy](SOCIAL_MEDIA_STRATEGY.md) - Strategy for building community through social media
...
- **GitHub**: [Issues](https://github.com/Didier1111/connect/issues) and [Discussions](https://github.com/Didier1111/connect/discussions) (enable discussions in settings)
- **Discord**: [Join our server](#) (link to be added)
- **Twitter**: [@ProjectConnect](#) (account to be created)
- **LinkedIn**: [Project Connect](#) (page to be created)
...
- **Email**: [Contact us](mailto:#) (email to be added)
...
- **Sponsor** us through GitHub Sponsors (coming soon)
